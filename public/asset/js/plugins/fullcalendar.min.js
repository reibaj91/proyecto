...
!function (a) {
    ...
    var Sa, Ta, Ua, Va = {}.hasOwnProperty, Wa = /^\s*\d{4}-\d\d$/,
        Xa = /^\s*\d{4}-(?:(\d\d-\d\d)|(W\d\d$)|(W\d\d-\d)|(\d\d\d))((T| )(\d\d(:\d\d(:\d\d(\.\d+)?)?)?)?)?$/,
        Ya = b.fn, Za = a.extend({}, Ya);
    Ma.moment = function () {
        return ea(arguments)
    ...
    var bb = Ma.Emitter = ra.extend({
        ...
        view: null, isRTL: null, cellHtml: "<td/>", constructor: function (a) {
            ...
            var d = this.getHtmlRenderer("intro", b)(c || 0), e = this.getHtmlRenderer("outro", b)(c || 0),
                f = this.isRTL ? e : d, g = this.isRTL ? d : e;
    ...
    jb.mixin({
        ...
        eventsToInverseRanges: function (a) {
            var b, c, d = this.view, e = d.start.clone().stripZone(), f = d.end.clone().stripZone(),
                g = this.eventsToNormalRanges(a), h = [], i = a[0], j = e;
    ...
    kb.mixin({
        ...
        unlimitRow: function (a) {
            ...
            return a('<a class="fc-more"/>').text(this.getMoreLinkText(c.length)).on("click", function (f) {
                var g = e.opt("eventLimitClick"), h = b.start, i = a(this), j = d.getCellDayEl(b), k = d.getCellSegs(b),
                    l = d.resliceDaySegs(k, h), m = d.resliceDaySegs(c, h);
            ...
            var d, e = this.view, f = e.opt("theme"), g = b.start.format(e.opt("dayPopoverFormat")),
    ...
    lb.mixin({
        eventSkeletonEl: null, renderFgSegs: function (b) {
            ...
            var c, d, e, f = this.view, g = a.event, h = f.isEventDraggable(g),
                ...
                j = !b && a.isEnd && f.isEventResizableFromEnd(g), k = this.getSegClasses(a, h, i || j),
