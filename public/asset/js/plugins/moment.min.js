...
(function (a) {
    ...
    rc.DDDD = h(rc.DDD, 3), o(l.prototype, {
        ...
        _months: "Enero de_Febrero de_Marzo_Abril de_Mayo de_Junio de_Julio de_Agosto de_Septiembre de_Octubre de_Noviembre de_Diciembre de".split("_"),
        months: function (a) {
    ...
    vb.duration.fn.asMilliseconds = function () {
        ...
        ordinalParse: /\d{1,2}(th|st|nd|rd)/, ordinal: function (a) {
            var b = a % 10,
                c = 1 === C(a % 100 / 10) ? " de" : 1 === b ? " de" : 2 === b ? " de" : 3 === b ? " de" : " de";
            return a + c
        }
