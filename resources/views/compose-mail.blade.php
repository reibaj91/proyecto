                      ...
                      <div class="col-md-12 padding-0">
                        ...
                        <div class="col-md-9 col-sm-12 padding-0 mail-right">
                          ...
                          <div class="col-md-12 mail-right-tool">
                            <ul class="nav">
                                <li><h4>To:</h4></li>
                                <li><input type="text" class="txtinput border-none box-shadow-none" placeholder="email address.."/></li>
                            </ul>

                            <ul class="nav">
                              <li><h4>Subject:</h4></li>
                              <li> <input type="text" class="txtinput border-none box-shadow-none" placeholder="subject.."/></li>
                            </ul>
                          </div>
                          <div class="col-md-12 mail-right-content" style="padding=left:10px;">
                              <div class="col-md-12 padding-0">
                                <textarea class="summernote hidden" placeholder="Type Your Message.."></textarea>
                              </div>
                              <div class="col-md-12">
