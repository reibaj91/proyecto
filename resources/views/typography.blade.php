  		...
  		<div id="content">
           <div class="panel box-shadow-none content-header">
              <div class="panel-body">
                <div class="col-md-12">
                    <h3 class="animated fadeInLeft">Typography</h3>
                    <p class="animated fadeInDown">
                      Ui Element <span class="fa-angle-right fa"></span> Typography
                    </p>
                </div>
              </div>
          </div>
          <div class="col-md-12 typography padding-0">
              <div class="col-md-12">
                    <div class="col-md-5">
                         <div class="panel">
                            <div class="panel-body text-right">
                              <p >
                                Integer ante arcu, accumsan a, <span class="text-info">consectetuer eget, posuere ut, mauris.</span> Donec sodales sagittis magna. Suspendisse enim turpis, dictum sed, iaculis a, condimentum nec, nisi. Fusce commodo aliquam arcu.
                                Suspendisse potenti. <b>Praesent</b> metus tellus, elementum eu, semper a, adipiscing nec, purus. Fusce vel dui. <span class="text-warning">Vivamus elementum semper nisi.</span>
                                Quisque id mi. Quisque id odio. <span class="text-danger">Donec vitae sapien ut libero</span> venenatis faucibus.
                                <span class="text-primary">Quisque malesuada placerat nisl.</span> Donec posuere vulputate arcu. Aenean tellus metus, bibendum sed, <span class="text-success">posuere ac, mattis non, nunc.</span>
                              </p>
                              <h1><code>H1</code> Headings <small>Sub Heading</small></h1>
                              <h2><code>H2</code> Headings <small>Sub Heading</small></h2>
                              <h3><code>H3</code> Headings <small>Sub Heading</small></h3>
                              <h4><code>H4</code> Headings <small>Sub Heading</small></h4>
                              <h5><code>H5</code> Headings <small>Sub Heading</small></h5>
                              <h6><code>H6</code> Headings <small>Sub Heading</small></h6>
                            </div>
                        </div>
                        <div class="panel">
                            <div class="panel-body">
                    ...
                    <div class="col-md-7">
                          ...
                          <div class="panel">
                              <div class="panel-body">
                                <ul class="list-unstyled">
                                  <li>Integer ante arcu</li>
                                  <li>Suspendisse potenti.</li>
                                  <li>Quisque malesuada</li>
                                  <li>aliquam arcu
                                    <ul>
                                        <li>placerat</li>
                                        <li>elementum eu</li>
                                  ...
                                  <li>Aenean tellus metus</li>
                                  <li>commodo aliquam arcu.</li>
                                </ul>
                              </div>
                          </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="panel">
                                <div class="panel-body">
                                    <address>
                                        <strong>Mimin Dev</strong><br>
                                        Jl. Indonesia Raya<br>
                                        Batavia,Central Java <br>
                        ...
                        <div class="col-md-6">
                            <div class="panel">
                              <div class="panel-body">
                                ...
                                <p><var>y</var> = <var>m</var><var>x</var> + <var>b</var> for variable</p>
