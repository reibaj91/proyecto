      ...
      <!-- start: Content -->
        <div id="content">
          ...
          <div class="col-md-12 top-20 padding-0">
            ...
            <div class="col-md-3">
              <div class="panel">
                <div class="panel-heading"><h3>Mini Timeline</h3></div>
                <div class="panel-body">
            ...
            <div class="col-md-3">
              ...
              <div class="panel-heading"><h3>Iconic Timeline</h3></div>
                <div class="panel-body">                  
                  <div class="col-md-12 iconic-timeline">
                    <div class="col-md-2 iconic-timeline-icon">
                      <i class="icon-pencil icons"></i>
                    </div>
                    <div class="col-md-10 iconic-timeline-detail">
                  ...
                  <div class="col-md-12 iconic-timeline">
                    <div class="col-md-2 iconic-timeline-icon">
                      <i class="icon-cup icons icon-primary"></i>
                    </div>
                    <div class="col-md-10 iconic-timeline-detail">
                      <span class="pull-right">21:00</span>
                      <h5>Break
                  ...
                  <div class="col-md-12 iconic-timeline">
                    <div class="col-md-2 iconic-timeline-icon">
                      <i class="icon-call-end icons icon-danger"></i>
                    </div>
                    <div class="col-md-10 iconic-timeline-detail">
                      <span class="pull-right">21:00</span>
                      <h5>Call the clients
                  ...
                  <div class="col-md-12 iconic-timeline">
                    <div class="col-md-2 iconic-timeline-icon">
                      <i class="icon-call-end icons icon-warning"></i>
                    </div>
                    <div class="col-md-10 iconic-timeline-detail">
                      <span class="pull-right">21:00</span>
                      <h5>Call the clients
                  ...
                  <div class="col-md-12 iconic-timeline">
                    <div class="col-md-2 iconic-timeline-icon">
                      <i class="icon-call-end icons icon-info"></i>
                    </div>
                    <div class="col-md-10 iconic-timeline-detail">
                      <span class="pull-right">21:00</span>
                      <h5>Call the clients
                  ...
                  <div class="col-md-12 iconic-timeline">
                    <div class="col-md-2 iconic-timeline-icon">
                      <i class="icon-call-end icons icon-success"></i>
                    </div>
                    <div class="col-md-10 iconic-timeline-detail">
                      <span class="pull-right">21:00</span>
                      <h5>Call the clients
                  ...
                  <div class="col-md-12 iconic-timeline">
                    <div class="col-md-2 iconic-timeline-icon">
                      <i class="icon-call-end icons icon-default"></i>
                    </div>
                    <div class="col-md-10 iconic-timeline-detail">
                      <span class="pull-right">21:00</span>
                      <h5>Call the clients
