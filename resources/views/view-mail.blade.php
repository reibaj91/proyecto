                      ...
                      <div class="col-md-9 col-sm-12 col-xs-12 mail-right">
                          ...
                          <div class="col-md-12 col-sm-12 col-xs-12 mail-right-tool">
                            <div class="col-md-12 col-sm-12 col-xs-12 ">
                                <h4><span>Subject:</span> <b>Praesent congue erat at massa</b></h4>
                            </div>
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <h5><span>From:</span> Akihiko.avaron@gmail.com</h5>
                                <span class="pull-right">21:10 PM,14 July 1996</span>
                            </div>                       
                          </div>
                          <div class="col-md-12 col-sm-12 col-xs-12 mail-right-content padding-0">
                             <div class="col-md-12 col-sm-12 col-xs-12 mail-right-text">
                                <h4>Hi Bro!</h4>
                                <p>
                                    Praesent porttitor, nulla vitae posuere iaculis, arcu nisl dignissim dolor, a pretium mi sem ut ipsum. Quisque rutrum. Nullam quis ante. Fusce egestas elit eget lorem. Nunc nec neque.

                                  Fusce pharetra convallis urna. In hac habitasse platea dictumst. Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Phasellus blandit leo ut odio. Sed magna purus, fermentum eu, tincidunt eu, varius ut, felis.

                                  Praesent congue erat at massa. Phasellus dolor. Praesent egestas neque eu enim. Morbi nec metus. Donec orci lectus, aliquam ut, faucibus non, euismod id, nulla.

                                  Nullam dictum felis eu pede mollis pretium. Praesent metus tellus, elementum eu, semper a, adipiscing nec, purus. Donec venenatis vulputate lorem. Vivamus euismod mauris. Vivamus laoreet.

                                  Nulla neque dolor, sagittis eget, iaculis quis, molestie non, velit. Phasellus gravida semper nisi. Suspendisse non nisl sit amet velit hendrerit rutrum. Mauris sollicitudin fermentum libero. Nullam vel sem.  
                                </p>
                             </div>
                             ...
                             <div class="col-md-12 col-sm-12 col-xs-12 mail-reply">
                                <textarea class="summernote">Type Your Message..</textarea>
                                <div class="col-md-12 col-sm-12 col-xs-12 ">
