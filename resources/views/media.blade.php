            ...
            <div class="media-wrapper">
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-6">
                        <h3 class="animated fadeInLeft">Media Player</h3>
                        <p class="animated fadeInDown">
                          Ui Element <span class="fa-angle-right fa"></span> Media Player
                        </p>
                    </div>
                    <div class="col-md-6">
                      <div class="col-md-12" style="padding-top:30px;">
                            <h4><span class="fa fa-music"></span> &nbsp Audio Player</h4>
                ...
                <div class="col-md-12">
                    <div class="col-md-6 video-v1">
                        <div class="panel">
                           <div class="embed-responsive embed-responsive-16by9">
                            <iframe class="embed-responsive-item" src="asset/media/demo.mp4" allowfullscreen=""></iframe>
                          </div>
                          <div class="panel-body">
                              <div class="col-md-12 video-v1-header">
                                <div class="col-md-6">
                                  <h4><span class="fa fa-video-camera"></span> Embed Video</h4>
                                  <p class="video-v1-time">
                                  <span class=""></span>
                                  October 21, 1996</p>
                                </div>
                                <div class="col-md-6 video-v1-rate">
                                    <span class="fa fa-star fa-2x"></span>
                                    <span class="fa fa-star fa-2x"></span>
                                    <span class="fa fa-star fa-2x"></span>
                                    <span class="fa fa-star fa-2x"></span>
                                    <span class="fa fa-star-half fa-2x"></span>
                                </div>
                              </div>
                              ...
                              <div class="col-md-12 video-v1-footer">
                                <div class="col-md-12">
                                  <span class="fa fa-thumbs-up"> 28112</span>
                                  <span class="fa fa-thumbs-down"> 22</span>
                                  <span class="fa fa-comment-o"> 2810</span>
                                </div>
                              </div>
                          </div>
                        </div>
                    ...
                    <div class="col-md-6 custom-video-player video-v2">
                        <div class="panel"  style="padding-bottom:17px;">
                            <video style="width:100%;height:100%;" poster="asset/img/demo-video.png">
                              <source src="asset/media/demo.mp4" type="video/mp4">
                            </video>

                             <div class="panel-body">
                                <div class="col-md-12 video-v2-header">
                                  <p class="video-v2-time">
                                    <span class=""></span>
                                    October 21, 1996</p>
                                  <div class="col-md-6">
                                    <h4><span class="fa fa-video-camera"></span> Html5 Video</h4>
                                  </div>
                                  <div class="col-md-6 video-v2-rate">
                                      <span class="fa fa-thumbs-up"> 28112</span>
                                      <span class="fa fa-thumbs-down"> 22</span>
                                  </div>
                                </div>
                                
                                <div class="col-md-12 video-v2-content">
                                  <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s. Over the years, sometimes by accident, sometimes on purpose (injected humour and the like).</p>
                                </div>
                              
                                <div class="col-md-12 video-v2-footer">
                                  <div class="col-md-12">
                                    
                                    <span class="fa fa-comment-o"> 2810 Comments</span>
                                  </div>
                                </div>
                          </div>
                        </div>
