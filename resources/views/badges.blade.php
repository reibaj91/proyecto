          ...
          <div class="notifications-wrapper">
            <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Label & Badges</h3>
                        <p class="animated fadeInDown">
                          Ui Element <span class="fa-angle-right fa"></span> Label & Badges
                        </p>
                    </div>
                  </div>
            </div>
            <div class="col-md-12 padding-0">
                <div class="col-md-6">
                  <div class="panel" style="padding-bottom:20px;">
                    ...
                    <div class="panel-body">
                      ...
                      <div class="col-md-12 padding-0 top-20">
                      ...
                      <div class="col-md-12 top-20 padding-0">
                        <span class="label label-gradient label-default">Default</span>
                        <span class="label label-gradient label-primary">Primary</span>
                        <span class="label label-gradient label-success">Success</span>
                        <span class="label label-gradient label-info">Info</span>
                        <span class="label label-gradient label-warning">Warning</span>
                        <span class="label label-gradient label-danger">Danger</span>
                      </div>
                      <div class="col-md-12 top-20 padding-0">
                        <span class="label label-raised label-default">Default</span>
                        <span class="label label-raised label-primary">Primary</span>
                        <span class="label label-raised label-success">Success</span>
                        <span class="label label-raised label-info">Info</span>
                        <span class="label label-raised label-warning">Warning</span>
                        <span class="label label-raised label-danger">Danger</span>
                      </div>
                      <div class="col-md-12 top-20 padding-0">
                        <span class="label label-3d label-default">Default</span>
                        <span class="label label-3d label-primary">Primary</span>
                        <span class="label label-3d label-success">Success</span>
                        <span class="label label-3d label-info">Info</span>
                        <span class="label label-3d label-warning">Warning</span>
                        <span class="label label-3d label-danger">Danger</span>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="panel">
                    ...
                    <div class="panel-body">
                      <div class="col-md-12">
                        <a href="#">Inbox <span class="badge badge-primary">42</span></a>
                      ...
                      <div class="col-md-12">
                       <a href="#">Inbox <span class="badge badge-default">42</span></a>
                       <button class="btn btn-default" type="button">
                        Messages <span class="badge">4</span>
                       </button>
                      </div>
                      <div class="col-md-12">
                       <a href="#">Inbox <span class="badge badge-success">42</span></a>
                      ...
                      <div class="col-md-12">
                       <a href="#">Inbox <span class="badge badge-danger">42</span></a>
                          ...
                          <div class="col-md-4 padding-0">
                            <div class="badges-v1">
                             <div class="badges-ribbon">
                              <div class="badges-ribbon-content badge-success">SUCCESS</div>
                            </div>
                          </div>
                          </div>
                          <div class="col-md-4 padding-0">
                            <div class="badges-v1">
                             <div class="badges-ribbon">
                              <div class="badges-ribbon-content badge-primary">PRIMARY</div>
                            </div>
                          </div>
                          </div>
                          <div class="col-md-4 padding-0">
                            <div class="badges-v1">
                              <div class="badges-ribbon">
                                <div class="badges-ribbon-content badge-info">INFO</div>
                              </div>
                            </div>
                          </div>
                          <div class="col-md-4 padding-0">
                            <div class="badges-v1">
                             <div class="badges-ribbon">
                              <div class="badges-ribbon-content badge-danger">DANGER</div>
                            </div>
                          </div>
                          </div>
                          <div class="col-md-4 padding-0">
                            <div class="badges-v1">
                              <div class="badges-ribbon">
                                <div class="badges-ribbon-content badge-default">DEFAULT</div>
                              </div>
                            </div>
                          </div>
                          <div class="col-md-4 padding-0">
                            <div class="badges-v1">
                             <div class="badges-ribbon">
                              <div class="badges-ribbon-content badge-warning">WARNING</div>
                              </div>
                            </div>
                          </div>
                        </div>
