...
<body id="mimin" class="dashboard">
      ...
      <div class="col-md-12 col-xs-12 col-sm-12 padding-0" style="margin-top:20px;">
             <div class="col-md-6 col-sm-12 col-xs-12">
              <div class="panel chart-title" style="border-left:4px solid #1ab394">
                    <h3 style="color:#1ab394;">
                        <span id="sparkline2"></span> &nbsp Jquery SparkLine
                    </h3>
                  </div>
              <div class="panel">
                        <div class="panel-body">
                          <table class="table">
                              ...
                              <tr>
                                <td><span class="discrete"></span></td>
                              </tr>
                              <tr>
                                <td><span class="bar-sparkline"></span></td>
                              </tr>
                              <tr>
                                <td><span class="tristate"></span></td>
                              </tr>
                              <tr>
                                <td><span class="discrete"></span></td>
                              </tr>
                              <tr>
                                <td><span class="box-plot"></span></td>
                              </tr>
                              <tr>
            ...
            <div class="col-md-6 col-sm-12 col-xs-12 padding-0">
                <div class="col-md-12 col-sm-12 col-xs-12 padding-0">
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="panel" style="padding:20px;border-bottom:2px solid #FFF;background:#1ab394;">
                              <div class="panel-body" style="height:200px;">
                              <span class="icon-music-tone-alt icons" style="color:#FFF;font-size:3em;position:absolute;"></span>
                              <span class="icon-music-tone icons" style="color:#FFF;font-size:2em;position:absolute;margin-right:40px;margin-top:50px;"></span>
                                <span id="sparkline8" style="position:absolute;margin-left:-20px;margin-top:50px;"></span>
                              </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-12 col-xs-12">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 padding-0">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="panel" style="background:#1AB394;">
                              <div class="panel-body" style="height:240px;">
                                <center>
    ...
    <!-- custom -->
     ...
     <script type="text/javascript">
      ...
      (function(){
          ...
          $("#sparkline1").sparkline([0,0.4,0.6,1,1.5,1.6,1.9,2,2.3,2.9,3,3.5,4,4.5,4.5,4.7,4.5,4.5,4], {
              type: 'line',
              lineColor: '#17997f',
              fillColor: '#17997f',
          });
          ...
          $("#sparkline6").sparkline([4, 6, 7, 7, 4, 3, 2, 1, 4, 4, 5, 6, 3, 4, 5, 8, 7, 6, 9, 3, 2, 4, 1, 5, 6, 4, 3, 7, 7, 4, 3, 2, 1, 4, 4, 5, 6, 3, 4, 4, 5, 6, 3, 4, 5, 8, 2, 1, 4, 4, 5, 6, 3, 4, 4, 5], {
              type: 'discrete',
              height:'150px',
              lineColor: '#1ab394'});
          ...
          $("#sparkline8").sparkline([9,3, 5, 1, 2, 5, 9,5, 8, 2, 5, 3, 9, 3, 5, 1, 2, 5, 9, 12, 15, 5,4,2], {
              type: 'bar',
              barWidth: 8,
              height: '150px',
              barColor: '#FFF'});

          $("#sparkline9").sparkline([20,24,40,32,50,70,25,34], {
              type: 'line',
              lineWidth: 2,
              height: '150px',
              width:'200px',
          ...
          $(".bar-sparkline").sparkline([5,6,7,2,0,-4,-2,4], {
            type: 'bar',
            barColor: '#1ab394',
            negBarColor: '#ddddd'
          });
          ...
          $(".bullet").sparkline([10,12,12,9,7], {
            type: 'bullet',
            targetColor: '#dddddd',
            performanceColor: '#1ab394',
            rangeColors: ['#d3dafe','#a8b6ff','#e4f0fb']});

          $(".box-plot").sparkline([4,27,34,52,54,59,61,68,78,82,85,87,91,93,100], {
            type: 'box',
            boxFillColor: '#1ab394'});
