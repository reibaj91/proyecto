              ...
              <div class="col-md-12">
                  ...
                  <div class="col-md-12 tabs-area">
                    ...
                    <ul id="tabs-demo6" class="nav nav-tabs nav-tabs-v6" role="tablist">
                      <li role="presentation" class="active">
                        <a href="#tabs-demo7-area1" id="tabs-demo6-1" role="tab" data-toggle="tab" aria-expanded="true">Menu 1</a>
                      </li>
                      <li role="presentation" class="">
                ...
                <div class="col-md-6">
                  <div class="col-md-12 tabs-area">
                    ...
                    <ul id="tabs-demo2" class="nav nav-tabs nav-tabs-v1" role="tablist">
                      <li role="presentation" class="active">
                        <a href="#tabs-demo2-area1" id="tabs-demo2-1" role="tab" data-toggle="tab" aria-expanded="true">Menu 1</a>
                      </li>
                      <li role="presentation" class="">
                        <a href="#tabs-demo2-area2" role="tab" id="tabs-demo2-2" data-toggle="tab" aria-expanded="false">Menu 2</a>
                      </li>
                      <li role="presentation">
                        <a href="#tabs-demo2-area3" id="tabs-demo2-3" role="tab" data-toggle="tab" aria-expanded="false">Menu 3</a>
                      </li>
                      <li role="presentation" class="">
                        <a href="#tabs-demo2-area4" role="tab" id="tabs-demo2-4" data-toggle="tab" aria-expanded="false">Menu 4</a>
                      </li>
                    </ul>
                    <div id="tabsDemo2Content" class="tab-content tab-content-v1 col-md-12">
                      ...
                      <div role="tabpanel" class="tab-pane fade" id="tabs-demo2-area2" aria-labelledby="tabs-demo2-area2">
                        <p>Raw denim you probably haven't heard of them jean shorts Austin. Nesciunt tofu stumptown aliqua, retro synth master cleanse. Mustache cliche tempor, williamsburg carles vegan helvetica. Reprehenderit butcher retro keffiyeh dreamcatcher synth. Cosby sweater eu banh mi, qui irure terry richardson ex squid. Aliquip placeat salvia cillum iphone. Seitan aliquip quis cardigan american apparel, butcher voluptate nisi qui.</p>
                      </div>
                      <div role="tabpanel" class="tab-pane fade" id="tabs-demo2-area3" aria-labelledby="tabs-demo2-area3">
                        <p>Raw denim you probably haven't heard of them jean shorts Austin. Nesciunt tofu stumptown aliqua, retro synth master cleanse. Mustache cliche tempor, williamsburg carles vegan helvetica. Reprehenderit butcher retro keffiyeh dreamcatcher synth. Cosby sweater eu banh mi, qui irure terry richardson ex squid. Aliquip placeat salvia cillum iphone. Seitan aliquip quis cardigan american apparel, butcher voluptate nisi qui.</p>
                      </div>
                      <div role="tabpanel" class="tab-pane fade" id="tabs-demo2-area4" aria-labelledby="tabs-demo2-area4">
                        <p>Raw denim you probably haven't heard of them jean shorts Austin. Nesciunt tofu stumptown aliqua, retro synth master cleanse. Mustache cliche tempor, williamsburg carles vegan helvetica. Reprehenderit butcher retro keffiyeh dreamcatcher synth. Cosby sweater eu banh mi, qui irure terry richardson ex squid. Aliquip placeat salvia cillum iphone. Seitan aliquip quis cardigan american apparel, butcher voluptate nisi qui.</p>
                      </div>
                    </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="col-md-12 tabs-area">
                     <ul id="tabs-demo4" class="nav nav-tabs nav-tabs-v3" role="tablist">
                      <li role="presentation" class="active">
                        <a href="#tabs-demo4-area1" id="tabs-demo4-1" role="tab" data-toggle="tab" aria-expanded="true">Menu 1</a>
                      </li>
                      <li role="presentation" class="">
                        <a href="#tabs-demo4-area2" role="tab" id="tabs-demo4-2" data-toggle="tab" aria-expanded="false">Menu 2</a>
                      </li>
                      <li role="presentation">
                        <a href="#tabs-demo4-area3" id="tabs-demo4-3" role="tab" data-toggle="tab" aria-expanded="false">Menu 3</a>
                      </li>
                      <li role="presentation" class="">
                        <a href="#tabs-demo4-area4" role="tab" id="tabs-demo4-4" data-toggle="tab" aria-expanded="false">Menu 4</a>
                      </li>
                    </ul>
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-md-12 tabs-area ">
                    <ul id="tabs-demo5" class="nav nav-tabs nav-tabs-v4" role="tablist">
                      <li role="presentation" class="active">
                        <a href="#tabs-demo5-area1" id="tabs-demo5-1" role="tab" data-toggle="tab" aria-expanded="true"><span class="fa fa-flag"></span></a>
                      </li>
                      <li role="presentation" class="">
                        <a href="#tabs-demo5-area2" role="tab" id="tabs-demo5-2" data-toggle="tab" aria-expanded="false"><span class="fa fa-lock"></span></a>
                      </li>
                      <li role="presentation">
                        <a href="#tabs-demo5-area3" id="tabs-demo5-3" role="tab" data-toggle="tab" aria-expanded="false"><span class="fa fa-eye"></span></a>
                      </li>
                      <li role="presentation" class="">
                        <a href="#tabs-demo5-area4" role="tab" id="tabs-demo5-4" data-toggle="tab" aria-expanded="false"><span class="fa fa-envelope"></span></a>
                      </li>
                    </ul>
                    <div id="tabsDemo5Content" class="tab-content tab-content-v4">
                      <div role="tabpanel" class="tab-pane fade active in" id="tabs-demo5-area1" aria-labelledby="tabs-demo5-area1">
                        <p>Raw denim you probably haven't heard of them jean shorts Austin. Nesciunt tofu stumptown aliqua, retro synth master cleanse. Mustache cliche tempor, williamsburg carles vegan helvetica. Reprehenderit butcher retro keffiyeh dreamcatcher synth. Cosby sweater eu banh mi, qui irure terry richardson ex squid. Aliquip placeat salvia cillum iphone. Seitan aliquip quis cardigan american apparel, butcher voluptate nisi qui.</p>
                      </div>
                      <div role="tabpanel" class="tab-pane fade" id="tabs-demo5-area2" aria-labelledby="tabs-demo5-area2">
                        <p>Raw denim you probably haven't heard of them jean shorts Austin. Nesciunt tofu stumptown aliqua, retro synth master cleanse. Mustache cliche tempor, williamsburg carles vegan helvetica. Reprehenderit butcher retro keffiyeh dreamcatcher synth. Cosby sweater eu banh mi, qui irure terry richardson ex squid. Aliquip placeat salvia cillum iphone. Seitan aliquip quis cardigan american apparel, butcher voluptate nisi qui.</p>
                      </div>
                      <div role="tabpanel" class="tab-pane fade" id="tabs-demo5-area3" aria-labelledby="tabs-demo5-area3">
                        <p>Raw denim you probably haven't heard of them jean shorts Austin. Nesciunt tofu stumptown aliqua, retro synth master cleanse. Mustache cliche tempor, williamsburg carles vegan helvetica. Reprehenderit butcher retro keffiyeh dreamcatcher synth. Cosby sweater eu banh mi, qui irure terry richardson ex squid. Aliquip placeat salvia cillum iphone. Seitan aliquip quis cardigan american apparel, butcher voluptate nisi qui.</p>
                      </div>
                      <div role="tabpanel" class="tab-pane fade" id="tabs-demo5-area4" aria-labelledby="tabs-demo5-area4">
                        <p>Raw denim you probably haven't heard of them jean shorts Austin. Nesciunt tofu stumptown aliqua, retro synth master cleanse. Mustache cliche tempor, williamsburg carles vegan helvetica. Reprehenderit butcher retro keffiyeh dreamcatcher synth. Cosby sweater eu banh mi, qui irure terry richardson ex squid. Aliquip placeat salvia cillum iphone. Seitan aliquip quis cardigan american apparel, butcher voluptate nisi qui.</p>
                      </div>
                    </div>
                  </div>
