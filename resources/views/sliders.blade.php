      ...
      <div class="container-fluid mimin-wrapper">
          ...
          <div id="content">
            <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <h3 class="animated fadeInLeft">Sliders</h3>
                        <p class="animated fadeInDown">
                         Ui Element <span class="fa-angle-right fa"></span> Sliders
                        </p>
                    </div>
                  </div>
              </div>
            ...
            <div class="col-md-6 col-sm-12 col-xs-12">
              <div class="panel">
                <div class="panel-heading">
                  <center><h3>With Caption</h3></center>
                </div>
                <div class="panel-body">
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <div id="carousel-example-captions" class="carousel slide" data-ride="carousel">
                      ...
                      <div class="carousel-inner">
                        <div class="item">
                          <img class="img-responsive" data-src="holder.js/900x500/auto/#777:#777" alt="900x500" src="asset/img/bg1.jpg">
                        ...
                        <div class="item active">
                          <img class="img-responsive" data-src="holder.js/900x500/auto/#666:#666" alt="900x500" src="asset/img/bg1.jpg">
                          <div class="carousel-caption">
                        ...
                        <div class="item">
                          <img class="img-responsive" data-src="holder.js/900x500/auto/#555:#5555" alt="900x500" src="asset/img/bg1.jpg">
                          <div class="carousel-caption">
                ...
                <div class="panel-body" style="padding-bottom:70px;">
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <ol class="carousel-thumb-img carousel-indicator">
                      <li data-target="#carousel-example2" data-slide-to="0" class="active carousel-thumb-img-li">
                        <img class="img-responsive" data-src="holder.js/900x500/auto/#777:#555/text:First slide" alt="First slide" src="asset/img/bg1.jpg">
                      </li>
                      <li data-target="#carousel-example2" data-slide-to="1" class="carousel-thumb-img-li">
                       <img class="img-responsive" data-src="holder.js/900x500/auto/#777:#555/text:First slide" alt="First slide" src="asset/img/bg1.jpg">
                     </li>
                     <li data-target="#carousel-example2" data-slide-to="2" class="carousel-thumb-img-li">
                       <img class="img-responsive" data-src="holder.js/900x500/auto/#777:#555/text:First slide" alt="First slide" src="asset/img/bg1.jpg">
                     </li>
                   </ol>
                 </div>
           ...
           <div class="col-md-7 col-sm-12 col-xs-12">
            <div class="panel">
              <div class="panel-heading">
                <center><h3>with Animation.css</h3></center>
              </div>
              <div class="panel-body">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="carousel-inner" role="listbox">
                      ...
                      <div class="item active">
                        ...
                        <div class="carousel-caption">
                          ...
                          <h5 data-animation="animated bounceInRight">
                      ...
                      <div class="item">
                        <img class="img-responsive" data-src="holder.js/900x500/auto/#777:#555/text:First slide" alt="First slide" src="asset/img/bg1.jpg">
                        <div class="carousel-caption">
                          <h1 class="icon-container" data-animation="animated bounceInDown">
