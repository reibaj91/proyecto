                ...
                <div class="col-md-12">
                 ...
                 <ul id="tabs-demo6" class="nav nav-tabs nav-tabs-v6 masonry-tabs" role="tablist">
                    <li role="presentation" class="active">
                      <a href="#tabs-demo7-area1" id="tabs-demo6-1" role="tab" data-toggle="tab" aria-expanded="true">Article</a>
                    </li>
                    <li role="presentation" class="">
                      <a href="#tabs-demo7-area2" role="tab" id="tabs-demo6-2" data-toggle="tab" aria-expanded="false">User</a>
                    </li>
                    <li role="presentation" class="">
                      <a href="#tabs-demo7-area3" role="tab" id="tabs-demo6-4" data-toggle="tab" aria-expanded="false">Images</a>
                    </li>
                  </ul>
              </div>
            </div>
                        ...
                        <h4> 2.281.291 results found for: “Miminium Project”</h4></br></br>
                          <div class="media">
                                <div class="media-left">
                                  <a href="#">
                                    <img src="asset/img/avatar2.png" class="media-object search-v1-avatar"/>
                                  </a>
                                </div>
                                <div class="media-body">
                                  <h4 class="media-heading">Fulan</h4>
                                   <p>It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
                                   <a href="">
                                     <i class="icon-user icons"></i> 2819 follower
                                   </a>
                                   <a href=""> | <i class="icon-user icons"></i> 29 following</a>
                                </div>
                              </div>
                          ...
                          <div class="media">
                                <div class="media-left">
                                  <a href="#">
                                    <img src="asset/img/avatar.jpg" class="media-object search-v1-avatar"/>
                                  </a>
                                </div>
                                <div class="media-body">
                                  <h4 class="media-heading">Fulan</h4>
                          ...
                          <div class="media">
                                <div class="media-left">
                                  <a href="#">
                                    <img src="asset/img/avatar3.png" class="media-object search-v1-avatar"/>
                                  </a>
                                </div>
                                <div class="media-body">
                        ...
                        <h4> 2.281.291 results found for: “Miminium Project”</h4></br></br>
                          <div class="row masonry-container">
                            <div class="col-md-4 col-sm-6 col-xs-12 item">
                              <div class="thumbnail">
                                <img class="img-responsive" src="holder.js/400x400" alt="">
                              </div>
                            </div><!--/.item  -->
