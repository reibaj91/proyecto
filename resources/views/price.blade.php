            ...
            <div id="content">
              <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Price</h3>
                        <p class="animated fadeInDown">
                          Ui Element <span class="fa-angle-right fa"></span> Price
                        </p>
                    </div>
                  </div>
              </div>
              <div class="col-md-12">
                <div class="row">
                    <div class="col-sm-6 col-md-3 price">
                      <div class="panel">
                        <div class="panel-header bg-dark-purple">
                        </div>

                        <div class="panel-header text-white bg-purple price-money text-center">
                          <span>
                              <sup>$</sup>90<sub>/mo</sub>
                              </span>
                        </div>
                         <ul class="list-group text-center">
                            ...
                            <center>
                              <input type="button" class="btn box-shadow-none btn-danger" value="Order Now"/>
                              </center>
                            </li>
                          </ul>
                      </div>
                    ...
                    <div class="col-sm-6 col-md-3 price">
                      <div class="panel">
                        ...
                        <div class="panel-header price-money text-center">
                          <span>
                              <sup>$</sup>90<sub>/mo</sub>
                              </span>
                        </div>
                         <ul class="list-group text-center">
                            ...
                            <li class="list-group-item" style="padding:20px;">
                            <center>
                              <input type="button" class="btn box-shadow-none text-white bg-dark-purple" value="Order Now"/>
                              </center>
                            </li>
                          </ul>
                      </div>
                    ...
                    <div class="col-sm-6 col-md-3 price padding-0">
                      <div class="panel">
                         <div class="badges-ribbon">
                          <div class="badges-ribbon-content badge-success">NEW</div>
                        </div>
                        <div class="panel-header text-white bg-blue price-money text-center">
                         ...
                         <ul class="list-group text-center">
                            ...
                            <li class="list-group-item" style="padding:20px;">
                            <center>
                              <input type="button" class="btn box-shadow-none text-white bg-indigo" value="Order Now"/>
                              </center>
                            </li>
                          </ul>
                      </div>
                    ...
                    <div class="col-sm-6 col-md-3 price">
                      <div class="panel">
                        <div class="panel-header text-white bg-red price-money text-center">
                          <span>
                              <sup>$</sup>90<sub>/mo</sub>
                              </span>
                        </div>
                         <ul class="list-group text-center">
                            ...
                            <li class="list-group-item" style="padding:20px;">
                            <center>
                              <input type="button" class="btn box-shadow-none text-white bg-deep-orange" value="Order Now"/>
                              </center>
                            </li>
                          </ul>
                      </div>
