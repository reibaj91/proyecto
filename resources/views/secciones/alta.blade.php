    ...
    <div id="content">
            ...
            <div class="panel-body">
                <div class="col-md-12">
                    ...
                    <p class="animated fadeInDown">
                        Secciones <span class="fa-angle-right fa"></span> Alta
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-10 col-md-offset-1 panel">
            ...
            <div class="col-md-12 panel-body" style="padding-bottom:30px;">
                <div class="col-md-12">
                    <form class="cmxform" id="signupForm" method="post" action="{{route('secciones.store')}}" novalidate="novalidate">
                        @csrf
                       <div class="col-md-12">
                           <div class="form-group form-animate-text" style="margin-top:40px !important;">
                               <input type="text" class="form-text" id="idSeccion" name="idSeccion" required aria-required="true">
                               <span class="bar"></span>
...
@section('scripts')
    <script>
        ...
        function validarDatos(){
            ...
            $.ajax({
                url: '{{ route('secciones.pre-validar') }}',
                data: data,
                type: 'post',
