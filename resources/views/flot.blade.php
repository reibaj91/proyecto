...
<body id="mimin" class="dashboard">
          ...
          <!-- end: Left Menu -->
              ...
              <div class="col-md-6 padding-0">
                  <div class="col-md-12">
                    <div class="panel chart-title">
                      <h3><span class="fa fa-area-chart"></span> Flot Chart Js</h3>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="panel">
                  ...
                  <div class="col-md-12">
                      <div class="panel" style="padding:20px;">
                          <div class="panel-heading panel-heading-white">
                            <h4>Rectangular Chart</h4>
                          </div>
                          <div class="panel-body" style="padding-bottom:0px;">
                            <div id="rectangular-chart" style="height:200px;"></div>
                          </div>
                      </div>
                  </div>
              </div>
              ...
              <div class="col-md-12">
                <div class="panel" style="padding:20px;">
                  ...
                  <div class="panel-body" style="padding-bottom:0px;">
                    <div id="multi-axes-chart" style="height:400px;"></div>
                  </div>
                </div>
      		    </div>
          </div>
    ...
    <!-- custom -->
     ...
     function lineChart(){
          var dataLine = [
              {label: '&nbsp Trafic', color:'#58B2F4', data: [[1,25], [2,22], [3,25], [4,30], [5,20]]},
              {label: '&nbsp User', color:'#8C54CA', data: [[1,10], [2,14], [3,20], [4,25], [5,40]]}
          ];
     ...
     function rectangularChart(){
          var dataPie = [
              { label: "Alfa", color:'#15BA67', data: 50},
              { label: "Beta", color:'#58B2F4', data: 70},
              { label: "Beta", color:'#108BE5', data: 50},
              { label: "Gamma", color:'#8C54CA', data: 190}
          ];

          $.plot('#rectangular-chart', dataPie, {
              series: {
                  pie: {
                      show: true,
                      radius: 500,
     ...
     function doughnutChart(){
          var dataPie = [
              { label: "Alfa", color:'#8C54CA', data: 100},
                    { label: "Beta", color:'#58B2F4', data: 70},
                    { label: "Gamma", color:'#BBE0E9', data: 190}
                ];
              ...
              if (item) {
                  if (previousPoint != item.datapoint) {
                      ...
                      showTooltip(item.pageX, item.pageY,
                          "<b>" + item.series.label + "</b><br /> " + y + "&deg;C",
                          z);
                  }
              } else {
                  $("#flot-tooltip").remove();
      ...
      function multiAxesChart(){
        ...
        function doPlot(position) {
          $.plot("#multi-axes-chart", [
            { color:'#8C54CA',data: oilprices, label: "Oil price ($)" },
            { color:'#58B2F4',data: exchangerates, label: "USD/EUR exchange rate", yaxis: 2 }
          ], {
            xaxes: [ { mode: "time" } ],
            yaxes: [ { min: 0 }, {
